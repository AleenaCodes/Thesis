...
% TODO - change to v2 of this picture
...
% TODO - add newline, this gets split weirdly
...
The WCAG guidelines provide a framework for basic evaluation of an accessible page. The following table shows all relevant criteria and whether it is fulfilled. The only criteria that wasn't fully fulfilled was \textit{Criterion 1.4.11 - Non-Text Contrast}. This is due to the difficulty in find multiple colours with a contrast $\textgreater$4.5:1, although all colours do have a contrast of $\textgreater$3:1, which is fairly high. 
...
\begin{longtable}{|p{2cm}|p{5cm}|p{2cm}|p{5cm}|}
 ...
 \hline
 1.4.11 & Non-text Contrast & $\text{\rlap{.!.}}\square$ & Adjacent colour blocks have a fairly high contrast (\textgreater 3:1) but only some have (\textgreater 4.5:1)\\
 \hline
...
% TODO - more detail on contributions

% \section{Speed}

% Test speed against other libraries
...
% TODO - move WCAG table here?
% TODO - raw user survey results?
% TODO - picture of demo
% TODO - full list of questions asked


% TODO - change both headings that are WCAG to differing ones? i.e. "implementing WCAG" and "WCAG compliance"
