...
\begin{itemize}
    ...
    \item Almost 60\% of users said that the "Struggle to Understand" data visualisations on web pages, so it seems that many developers do not provide adequate descriptions for these, possibly because it can be complex to sum up large amounts of visual data succinctly
\end{itemize}
