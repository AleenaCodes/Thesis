...
\begin{figure}[H]
  \centering
  \subcaptionbox{What Operating System are you using?}[.4\linewidth][c]{%
    \includegraphics[width=.3\linewidth]{images/OperatingSystem.png}}\quad
  \subcaptionbox{What web browser are you using?}[.4\linewidth][c]{%
    \includegraphics[width=.3\linewidth]{images/WebBrowser.png}}\quad
\end{figure}

\begin{figure}[H]
  \centering
  \subcaptionbox{What screen-reader are you using?}[.3\linewidth][c]{%
    \includegraphics[width=.3\linewidth]{images/ScreenReader.png}}\quad
  \subcaptionbox{How long have you been using a screen-reader?}[.3\linewidth][c]{%
    \includegraphics[width=.3\linewidth]{images/HowLongUsingScreenReader.png}}\quad
  \subcaptionbox{How proficient would you rate yourself using a screen reader to navigate websites}[.3\linewidth][c]{%
    \includegraphics[width=.3\linewidth]{images/ProficientScreenReader.png}}\quad
\end{figure}
